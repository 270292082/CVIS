...
namespace SysFunc {
    ...
    public class Database
    {
        ...
        {
            string query = "UPDATE Staffs SET username = '" + staff.username + "', password = '" + staff.password + "', email = '" + staff.email + "', address = '" + staff.address + "', phone = '" + staff.phone + "' WHERE ID == " + staff.ID + ";";
            string query2 = "UPDATE Staffs_Info SET medicalLicense = '" + staff.medicalLicense + "', licenseExp = '" + staff.licenseExp + "' WHERE ID = '" + staff.ID + ";";
